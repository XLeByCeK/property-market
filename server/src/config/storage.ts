...
export const storageConfig = {
  ...
  uploadPrefix: (process.env.YANDEX_STORAGE_UPLOAD_PREFIX || 'property_images/uploads').replace(
    /^\/+|\/+$/g,
    ''
  ),
...
if (!storageConfig.hasCredentials) {
  console.warn(
    '\x1b[33m%s\x1b[0m',
    'WARNING: YANDEX_STORAGE_ACCESS_KEY_ID/SECRET not set. Image uploads to Yandex Object Storage will fail.'
  );
}
